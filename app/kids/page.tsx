...
export default async function Page() {
  const [sectionProducts, legacyProducts, section, design] = await Promise.all([getProductsBySectionSlug("kids"), getProductsByAudience("KIDS"), getCatalogSectionBySlug("kids"), getSiteDesign()]);
  const content = pageContent(design, "kids");
